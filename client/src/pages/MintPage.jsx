...
function MintPage() {
  ...
  useEffect(() => {
    ...
    // Total: 0.2 SOL (€23.75) = 0.1 service fee + 0.1 blockchain costs
    setEstimatedCost(0.2);
    console.log('✅ Estimated cost set to 0.2 SOL (€23.75) = 0.1 service fee + 0.1 blockchain costs');
  }, []);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (error.message?.includes('insufficient funds') || error.message?.includes('Attempt to debit')) {
        errorMessage = 'Insufficient SOL balance! You need at least 0.2 SOL (€23.75) to create tokens (0.1 SOL service fee + ~0.1 SOL blockchain costs).';
          ...
          <div className="card text-center">
            ...
            <div className="result-info">
              ...
              <div className="result-item">
                ...
                <a
                  href={`https://explorer.solana.com/address/${result.mintAddress}`}
                  target="_blank"
